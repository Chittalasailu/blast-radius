...
const START_BAT = [
  ...
  'echo.',
  '',
  'rem Give the server a moment to bind before the browser opens. The URL is',
  'rem left unquoted on purpose: cmd.exe has no backslash escaping, and a',
  'rem quoted first argument to `start` is treated as a window title.',
